    ...
    <div className="bg-white relative text-black h-[125px] my-4 px-6 flex items-center lg:justify-center shadow-2xl">
      <div className="absolute left-[1px] -translate-x-full">
        <svg width="17" height="125" viewBox="0 0 17 125" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_4814_8382)">
          <path fillRule="evenodd" clipRule="evenodd" d="M0 15.5172C0 6.94731 6.94731 0 15.5172 0H204.483C213.053 0 220 6.94731 220 15.5172V45C210.611 45 203 52.6112 203 62C203 71.3888 210.611 79 220 79V109.483C220 118.053 213.053 125 204.483 125H15.5172C6.94731 125 0 118.053 0 109.483V79C9.38884 79 17 71.3888 17 62C17 52.6112 9.38884 45 0 45V15.5172Z" fill="white"/>
          </g>
          <defs>
