    ...
    <>
        ...
        <section className='max-lg:py-14 lg:py-28 bg-white'>
            <div className='container text-center'>
                <TextBlock title="Top Up via Agent Partners" description="Cash in anywhere, anytime. <br /> Visit any of the <strong> 1,400+ OMT locations </strong> across Lebanon and top up your wallet in seconds. <br /> Just give the agent your Identity card, transaction ID, the money and watch your balance refresh instantly." center={true} />
        ...
        <section className="bg-white py-28 max-lg:py-14">
            <div className='container'>
                <div className='flex flex-col max-lg:gap-14 lg:gap-32'>
                    ...
                    <div className='flex items-center max-lg:gap-10 lg:gap-32 max-lg:flex-col'>
                        <div className='w-full'>
                            <TextBlock buttonColor="dark" title="Top Up via QR Code" description="Need to load your wallet on the spot? <br /> Top up instantly from any MyMonty user! <br /> Just let them scan your QR code, enter the amount, and your wallet is updated in seconds! <br />" />
                        </div>
                        <div className='w-full'>
