            ...
            <Section bg="bg-[#F7F7F7]">
                <div id="forex" className="container">
                    ...
                    <div className="my-10 py-10 ">
                        <div className="flex max-lg:flex-col gap-4 items-center bg-white rounded-[1.875rem] overflow-hidden">
                            <div className="flex-1 flex flex-col gap-4 px-10 py-14">
                                ...
                                <TextBlock buttonColor="dark" center={false} title="What’s Next" description="You’ll be able to settle USD bills directly from your LBP wallet and vice versa. <br /> <br /> One less thing to worry about!" button={false} />
                            </div>
                            <div className="flex-1">
                                <Image className="aspect-square object-cover" alt="Forex" src={sectionForexImage2} />
                            </div>
                        </div>
                    </div>
