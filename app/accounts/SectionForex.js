        ...
        <div>
            <Section bg="bg-[#F7F7F7]">
                <div id="forex" className="container">
                    ...
                    <div className="my-10 py-10">
                        <div className="flex max-lg:flex-col gap-4 items-center bg-white rounded-[1.875rem] overflow-hidden lg:max-h-[500px]">
                            <div className="flex-1 flex flex-col gap-4 p-4 lg:p-10">
