    ...
    return (
        <div className='flex md:justify-end'>
            <div className='h-[500px] relative flex justify-center'>
                <Image ref={imageElement} width="100" height="100" src="/animated/accounts-banner.webp" sizes='100%' alt='Image' className='w-full h-full -z-1' />
