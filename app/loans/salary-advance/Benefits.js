                ...
                <div className="flex max-lg:flex-col gap-4 md:gap-8">
                    ...
                    <div className="flex flex-col items-center text-center gap-3 bg-[#f7f7f7] rounded-2xl p-4 md:p-8 w-full">
                        <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M18.75 18.75C15.2982 18.75 12.5 21.5481 12.5 25C12.5 28.4519 15.2982 31.25 18.75 31.25" stroke="#2657D4" strokeWidth="4" />
                            <path d="M31.25 18.75C34.7019 18.75 37.5 21.5481 37.5 25C37.5 28.4519 34.7019 31.25 31.25 31.25" stroke="#2657D4" strokeWidth="4" />
                            <path d="M18.75 10.4167V38.5417" stroke="#2657D4" strokeWidth="4" strokeLinecap="round" />
                            <path d="M31.25 10.4167V38.5417" stroke="#2657D4" strokeWidth="4" strokeLinecap="round" />
                        </svg>
                        <h4 className="font-black uppercase">Fully digital, no waiting lines</h4>
                    </div>
                    <div className="flex flex-col items-center text-center gap-3 bg-[#f7f7f7] rounded-2xl p-4 md:p-8 w-full">
                        <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M43.75 27.0833C43.75 37.4387 35.3554 45.8333 25 45.8333C14.6447 45.8333 6.25 37.4387 6.25 27.0833C6.25 16.728 14.6447 8.33331 25 8.33331C35.3554 8.33331 43.75 16.728 43.75 27.0833Z" stroke="#2657D4" strokeWidth="4" />
                            <path d="M25 27.0833V18.75" stroke="#2657D4" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M20.834 4.16669H29.1673" stroke="#2657D4" strokeWidth="4" strokeLinecap="round" />
                        </svg>
                        <h4 className="font-black uppercase">Instant cash when needed </h4>
                    </div>
                </div>
                <div className='text-center'>
                    <button onClick={handleOriginalOpenModal} className='mm-button blue'>Download App</button>
                </div>
            </div>
        </section>
    )
