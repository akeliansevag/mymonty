    ...
    <section className='bg-white max-lg:py-16 lg:py-24'>
        <div className='container'>
            ...
            <div className='flex max-lg:flex-col gap-5 mt-10 text-center'>
                <div className='w-full bg-[#F7F7F7] rounded-3xl py-7 lg:px-32 max-lg:px-10 flex flex-col gap-5'>
                    <h4 className='font-black text-[20px]'>STEP 1</h4>
                    <h3 className='smaller-title uppercase text-balance text-center'>Download the <br /> MyMonty App</h3>
                    <img src='/car-step-1.webp' className='max-lg:max-w-[350px] mx-auto w-full'/>
                </div>
                <div className='w-full bg-[#F7F7F7] rounded-3xl py-7 lg:px-32 max-lg:px-10 flex flex-col gap-5'>
                    <h4 className='font-black text-[20px]'>STEP 2</h4>
                    <h3 className='smaller-title uppercase text-balance text-center'>Create an <br /> Account</h3>
                    <img src='/car-step-2.webp' className='max-lg:max-w-[350px] mx-auto w-full'/>
                </div>
            </div>

            <h4 className='text-center mt-10 font-black uppercase text-4xl'>That’s it! You’re entered automatically!</h4>
