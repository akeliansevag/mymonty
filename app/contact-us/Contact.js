        ...
        <div className='container'>
          ...
          <div className='flex gap-4 max-lg:px-5 px-10 py-10 bg-gray-100 mt-10 rounded-[1.875rem]'>
            ...
            <div className='flex flex-col gap-8'>
              ...
              <div className='flex flex-col gap-2'>
                <p className='uppercase font-bold leading-none'>Beirut Souks</p>
                <p className='font-bold leading-none'>Level G</p>
                <p className='leading-none'>Monday to Sunday 10:00 am – 10:00 pm</p>
              </div>
              <p className='leading-none italic'>Adjusted hours</p>
