...
const ContactUs = () => {
  const data = {
    ...
    subtitle: 'Contact Us',
    desc: 'You can contact us Monday to Sunday from 9:00 AM to 5:00 PM on WhatsApp at <a className="text-blue-500" target="_blank" href="https://wa.me/96171871871">+961 71 871 871</a> or send us an email at <a className="text-blue-500" href="supportlb@mymonty.com" target="_blank">supportlb@mymonty.com</a>. If you need assistance outside these hours, don\'t hesitate to contact our 24/7 Call Center at <a className="text-blue-500" target="_blank" href="tel:9611734020">+961 1 734 020</a>.',
    image: {
      inGrid: true,
      layout: 'half',
      url: contactUs,
