            ...
            <div className='mt-10 flex max-md:flex-col gap-5'>
                <div className='w-full flex flex-col gap-5 justify-between'>
                    <div className='bg-[#f7f7f7] h-full rounded-2xl p-8 flex items-center justify-center'>
                        <h4 className='text-center text-balance text-[22px]'>Guaranteed payments within standard MontyPay settlement cycle.</h4>
                    </div>
                    
                    <div className='bg-[#f7f7f7] rounded-2xl p-8 flex items-center justify-center'>
                        <h4 className='text-center text-balance text-[22px]'>Boost patient conversion with interest free for 3 months.</h4>
                    </div>
                    <div className='bg-[#f7f7f7] rounded-2xl p-8 flex items-center justify-center'>
                        <h4 className='text-center text-balance text-[22px]'>Increase procedure volumes and attract new clients.</h4>
                    </div>
                </div>
                ...
                <div className='w-full flex flex-col gap-5 justify-between'>
                    <div className='bg-[#f7f7f7] h-full rounded-2xl p-8 flex items-center justify-center'>
                        <h4 className='text-center text-balance text-[22px]'>Marketing support. In-clinic and digital promotional materials.</h4>
                    </div>
                    <div className='bg-[#f7f7f7] h-full rounded-2xl p-8 flex items-center justify-center'>
                        <h4 className='text-center text-balance text-[22px]'>Collect payments through MyMonty Business wallet</h4>
                    </div>
                    <div className='bg-[#f7f7f7] rounded-2xl p-8 flex items-center justify-center'>
                        <h4 className='text-center text-balance text-[22px]'>Zero financial risk. We manage all collections.</h4>
                    </div>
                </div>
            </div>
        </div>
