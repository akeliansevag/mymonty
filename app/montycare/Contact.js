...
const Contact = () => {
  ...
  const validateForm = () => {
    ...
    const requiredFields = ['first_name', 'last_name', 'email', 'code', 'mobile', 'address', 'clinic_name','specialty'];
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      try {
        ...
        const response = await fetch(`${apiUrl}/car-loan`, {
          method: 'POST',
          headers: {
              ...
              <div className='flex flex-col md:flex-row max-lg:gap-6 gap-10'>
                ...
                <div className='flex flex-col gap-1 w-full'>
                  ...
                  <input
                    ...
                    className={`px-3.5 py-2.5 border-2 w-full border-gray-300 rounded-xl ${errors.clinic_name ? 'border-red-500' : ''
                      }`}
                  />
                  <span className='text-red-500'>{errors.clinic_name}</span>
                </div>
              </div>
              ...
              <div className='flex flex-col md:flex-row max-lg:gap-6 gap-10'>
                <div className='flex flex-col gap-1 w-full'>
                  ...
                  <input
                    ...
                    className={`px-3.5 py-2.5 border-2 w-full border-gray-300 rounded-xl ${errors.specialty ? 'border-red-500' : ''
                      }`}
                  />
                  <span className='text-red-500'>{errors.specialty}</span>
                </div>
              </div>
              ...
              <div className='flex flex-col md:flex-row max-lg:gap-6 gap-10'>
                <div className='flex flex-col gap-1 w-full'>
                  ...
                  <textarea
                    ...
                    className={`px-3.5 py-2.5 border-2 w-full border-gray-300 rounded-xl ${errors.comments ? 'border-red-500' : ''
                      }`}
                  >
                    {formData.comments}
                </textarea>
