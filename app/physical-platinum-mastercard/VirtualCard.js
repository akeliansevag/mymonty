...
import sectionTwoImage from '@/public/physical-platinum-mastercard-banner.webp';
            ...
            <Section>
                <div className='max-w-[1060px] mx-auto w-full'>
                    ...
                    <div className='container'>
                        <div className='grid lg:grid-cols-2 max-lg:grid-cols-1 max-lg:gap-5 lg:gap-10 mt-10'>
                            <div className="bg-[#f7f7f7] rounded-2xl p-7">
                                <div className="flex items-center gap-5">
                                    <div className='bg-[var(--mm-blue)] rounded-full w-[80px] h-[80px] flex items-center justify-center'>
                            ...
                            <div className="bg-[#f7f7f7] rounded-2xl p-7">
                                <div className="flex items-center gap-5">
                                    <div className='bg-[var(--mm-blue)] rounded-full w-[80px] h-[80px] flex items-center justify-center'>
                                        <svg className='-mt-[1px]' width="40" height="46" viewBox="0 0 40 46" fill="none" xmlns="http://www.w3.org/2000/svg">
