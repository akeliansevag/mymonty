...
const AnimatedBanner = () => {
    ...
    return (
        <div className='flex md:justify-end md:mr-10'>
            <div className='w-full rounded-[30px] flex flex-col justify-end relative'>
