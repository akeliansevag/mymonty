...
import platinumPrepaidCard from '@/public/physical-platinum-mastercard.webp';
            ...
            <Section>
                <div className='max-w-[1060px] mx-auto w-full'>
                    <div className='container text-center'>
                        ...
                        <div id="euro-platinum" className="md:max-w-full lg:max-w-[60vw] fhd:max-w-[45vw] mx-auto mt-24">
