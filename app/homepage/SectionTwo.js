        ...
        <section className='bg-white pt-14 pb-14 lg:pt-28 lg:pb-20'>
            <div className='container text-center'>
                ...
                <div className='lg:w-1/2 mx-auto'>
                    <p className='leading-8 mt-8'>There's no need to stand in queues or handle stacks of paperwork, your account can be up and running in a matter of minutes. Just download the app and create an account. It's as straightforward as that.</p>
                </div>
