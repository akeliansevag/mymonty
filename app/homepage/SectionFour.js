...
import sectionImage from '@/public/sectionfiveimage3.webp';
        ...
        <section className='relative pt-14 pb-14 lg:pt-28  lg:pb-20 min-h-[calc(100vh-var(--mobile-header-height))] flex flex-col justify-center  bg-black text-white overflow-x-hidden'>
            ...
            <div className='md:flex md:items-center gap-10 relative z-10'>
                ...
                <div className='justify-end flex pb-10 md:pb-0'>
                    <Image src={sectionImage} alt='Section Image' placeholder='blur' className='w-full md:w-3/4 translate-x-[20%] 4xl:translate-x-0' />
                </div>
            </div>
        </section>
    )
