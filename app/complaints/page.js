...
export const metadata = {
  title: 'Complaints' + websiteName,
  description: 'Have a concern? MyMonty is here to help. Learn how to submit a complaint & get support for your digital banking issues in Lebanon. Contact us.',
};
                      ...
                      <div className='flex items-center gap-2'>
                        <div>
                          <svg xmlns="http://www.w3.org/2000/svg" width="19" height="20" viewBox="0 0 19 20" fill="none">
                            <g clipPath="url(#clip0_2468_25872)">
