                    ...
                    <div className="flex flex-col gap-10">
                        ...
                        <div className="lg:aspect-[16/5] max-lg:aspect-[16/12] relative flex items-end justify-end">
                            ...
                            <div className='absolute right-9 -top-6'>
                                ...
                                <g clip-path="url(#clip0_4972_8653)">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M98 18.4329C98 8.26025 89.7508 0.00135803 79.5947 0.00135803H18.4052C8.2492 0.00135803 0 8.26025 0 18.4329V77.569C0 87.7389 8.2492 96.0006 18.4053 96.0006H79.5947C89.7508 96.0006 98 87.7389 98 77.569L98 18.4329Z" fill="#0C3B7C"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M0.00390625 59.6406H48.949V96.0003H0.00394212L0.00390625 59.6406Z" fill="#0C3B7C"/>
