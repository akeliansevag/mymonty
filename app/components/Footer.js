...
const Footer = () => {
    ...
    return (
        <section className='bg-black text-white'>
            ...
            <div className='h-[1px] w-1/5 mx-auto mb-10 bg-white bg-opacity-10' />

            <div className='flex justify-center gap-8 items-center'>
                <a href='https://www.facebook.com/MyMontyLB' target='_blank' rel='noopener noreferrer nofollow'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_1218_43570)">
                            <path d="M24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 17.9895 4.3882 22.954 10.125 23.8542V15.4688H7.07812V12H10.125V9.35625C10.125 6.34875 11.9166 4.6875 14.6576 4.6875C15.9701 4.6875 17.3438 4.92188 17.3438 4.92188V7.875H15.8306C14.34 7.875 13.875 8.80008 13.875 9.75V12H17.2031L16.6711 15.4688H13.875V23.8542C19.6118 22.954 24 17.9895 24 12Z" fill="#727272"/>
                        </g>
                        <defs>
                ...
                <a href='https://www.linkedin.com/company/mymonty-lebanon/about/?viewAsMember=true' target='_blank' rel='noopener noreferrer nofollow'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_1218_43579)">
                            <path d="M22.2234 0H1.77187C0.792187 0 0 0.773438 0 1.72969V22.2656C0 23.2219 0.792187 24 1.77187 24H22.2234C23.2031 24 24 23.2219 24 22.2703V1.72969C24 0.773438 23.2031 0 22.2234 0ZM7.12031 20.4516H3.55781V8.99531H7.12031V20.4516ZM5.33906 7.43438C4.19531 7.43438 3.27188 6.51094 3.27188 5.37187C3.27188 4.23281 4.19531 3.30937 5.33906 3.30937C6.47813 3.30937 7.40156 4.23281 7.40156 5.37187C7.40156 6.50625 6.47813 7.43438 5.33906 7.43438ZM20.4516 20.4516H16.8937V14.8828C16.8937 13.5562 16.8703 11.8453 15.0422 11.8453C13.1906 11.8453 12.9094 13.2937 12.9094 14.7891V20.4516H9.35625V8.99531H12.7687V10.5609H12.8156C13.2891 9.66094 14.4516 8.70938 16.1813 8.70938C19.7859 8.70938 20.4516 11.0813 20.4516 14.1656V20.4516Z" fill="#727272"/>
                        </g>
                        <defs>
                ...
                <a href='https://www.youtube.com/channel/UCwDW4fXTnegDjn0FA_7c01w' target='_blank' rel='noopener noreferrer nofollow'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='container pt-10 pb-10 lg:pt-20 lg:pb-20'>
                <div class="nav flex flex-wrap flex-col md:flex-row justify-between">
                        ...
                        return (
                            <div key={index} className='max-lg:basis-1/3 mt-8'>
                                <span className='mb-2 sm:mb-5 block' >
                                    ...
                                    {!item.url && (
                                        <h6 class="flex justify-between item has-children cursor-pointer" onClick={() => handleClick(index)}>
