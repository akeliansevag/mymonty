            ...
            <div className='container relative h-full flex justify-between items-center'>
                <div className='flex gap-2 flex-1'>
                    ...
                    <svg onClick={handleRegionToggle} className='cursor-pointer dropdown-logo' width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
                        <path d='M6 9L12 15L18 9' stroke={(pathname == '/business' || pathname == '/business/business-wallet' || pathname == '/business/salary-domiciliation' || pathname == '/sign-up-and-win') ? '#FFFFFF' : '#000000'} strokeWidth='2' strokeLinecap='round' strokeLinejoin='round'></path>
                    </svg>
                </div>
