          ...
          <div ref={travelRef} data-name="travel" className="content-category">
            <div className="!pt-0">
              <div>
                ...
                <p>
                  Enjoy <strong>FREE</strong> unlimited access with one guest to
                  over 1,200 airport lounges in 450+ cities across 135+
                  countries through DragonPass, including business amenities,
                  Wi-Fi, and complimentary refreshments.
                </p>
              </div>
              ...
              <div>
                <div>
                  ...
                  <p>
                    ...
                    <strong>
                      3 months of unlimited complimentary lounge access with a
                      guest.
                    </strong>{" "}
                  </p>
                  <p>
            ...
            <div>
              <div>
                ...
                <p>
                  Airport Fast Track service across top Europe, Turkey & Asia
                  destinations with your World Elite Mastercard card. Download
                  Mastercard Travel Pass App now and book your complimentary
                  fast track pass.
                </p>
              </div>
              ...
              <div>
                ...
                <ul>
                  <li>
                    Download <strong>Mastercard Travel Pass</strong> App from{" "}
                    <a
                      href="https://apps.apple.com/lb/app/mastercard-travel-pass/id1493489553"
                      target="_blank"
                    >
                    ...
                    or click on the website and enter the Airport’s name into
                    airport search bar
                  </li>
                  <li>
                    Book your Fast Track Pass and receive it in the app or by
                    email
                  </li>
                  <li>
                    Go to the Fast Track zone in your terminal and present your
                    Fast Track pass to enter the priority lane
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div>
              <div>
                <h2>Trip.com</h2>
                <p>
                  Get up to <strong>20% off</strong> flights and hotels bookings
            ...
            <div>
              <div>
                ...
                <p>
                  Complimentary Titanium membership in the Global Hotel Alliance
                  DISCOVERY program, offering VIP perks at 500+ hotels
                  worldwide, including guaranteed room availability, double
                  upgrades, early check-in, late check-out, and Discovery Dollar
                  rewards.
                </p>
              </div>
              <div className="image-wrapper">
              ...
              <div>
                <p>
                  To activate, call World Elite Mastercard® Concierge to enroll,
                  then create an account at{" "}
                  <strong>
                    <a
                      href="https://www.ghadiscovery.com/gha-discovery-benefits"
                      target="_blank"
                    >
                      GHA DISCOVERY
                    </a>
            ...
            <div>
              ...
              <div>
                <p>
                  ...
                  is credited to your Booking.com wallet within 70 days.
                </p>
              </div>
            </div>
            ...
            <div>
              <div>
                <h2>HERTZ</h2>
                <p>
                  Become a Hertz Gold Plus Rewards® Presidents Circle Member for
                  great rates on rentals, upgrades and no queues with{" "}
                  <strong>World Elite Mastercard</strong>. Simply click 
                  <a href="https://hertz.com/worldelite" target="_blank">
                    hertz.com/worldelite
                  </a>
                   and add <strong>CDP1795034</strong>.
                </p>
              </div>
            ...
            <div>
              <div>
                ...
                <p>
                  Enjoy up to <strong>35% OFF</strong> your next car rental and
                  a complimentary upgrade with Avis through their{" "}
                  <a
                    href="https://one.avisworld.com/en_GB/Avis-MastercardMEA/"
                    target="_blank"
                  >
                    website
                  </a>
            ...
            <div>
              <div>
                ...
                <p>
                  ...
                  <a
                    href="https://www.rentalcars.com/?affiliateCode=%20mastercard047&enabler=mastercardme"
                    target="_blank"
                  >
                    Rentalcars.com
                  </a>
            ...
            <div>
              <div>
                ...
                <p>
                  ...
                  download the{" "}
                  <a
                    href="https://play.google.com/store/apps/details?id=com.flexiroamx&pcampaignid=web_share"
                    target="_blank"
                  >
                    Flexiroam App
                  </a>
          ...
          >
            ...
            <div>
              <div>
                <h2>Thriwe</h2>
                <p>
                  Get <strong>30% OFF</strong> or 1 complimentary guest to your
                  next golf game with Thriwe when using your World Elite
                  Mastercard® card! Click{" "}
                  <a href="https://mastercard.thriwe.com/" target="_blank">
                    mastercard.thriwe.com
                  </a>{" "}
                  to know more
                </p>
              </div>
              ...
              <div>
                ...
                <ul>
                  <li>
                    Go to mastercard.thriwe.com and register your World Elite
                    Mastercard® (First 6 Digits of card number)
                  </li>
                  <li>
                    Login or register using your email address and password
                  </li>
                  <li>
                    Enter the details of your preferred golf session for an
                    instant 30% off or select “Add guest booking” to redeem the
                    complimentary guest access
                  </li>
                  <li>
                    Get the discount when paying with your World Elite
                    Mastercard card
                  </li>
                </ul>
              </div>
            ...
            <div>
              <div>
                <h2>Express VPN</h2>
                <p>
                  Get 30-Days of complimentary trial from Express VPN and enjoy
                  either <strong>51% OFF</strong> a 12-month plan with 4 extra
                  months complimentary or <strong>61% OFF</strong> a 24-month
                  plan with 4 extra months complimentary!
                </p>
              </div>
              ...
              <div>
                ...
                <ul>
                  <li>
                    Download the ExpressVPN app from Google Play or the App
                    store
                  </li>
                  <li>
                    Visit 
                    <a
                      href="https://www.expressvpn.com/go/mastercard-mea"
                      target="_blank"
                    >
                      expressvpn.com/go/mastercard-mea
                    </a>{" "}
                    to activate your 30-day complimentary trial. Pay nothing
                    today, then enjoy 51% off a 12-month plan with 4 extra
                    months complimentary or 61% discount on a 24-month
                    plan including 4 extra complimentary months!
                  </li>
                  <li>
            ...
            <div>
              <div>
                ...
                <p>
                  ...
                  automatically. Get up to USD 500,000 in medical, accident, and
                  emergency evacuation insurance. Visit{" "}
                  <a href="https://mcpeaceofmind.com" target="_blank">
                    mcpeaceofmind.com/[TIER]
                  </a>{" "}
            ...
            <div className="!pb-0 !border-b-0">
              <div>
                ...
                <p>
                  ...
                  World Elite Mastercard®. Ensure visa requirements are met with
                  coverage for parents and children. Visit{" "}
                  <a href="https://mcpeaceofmind.com/" target="_blank">
