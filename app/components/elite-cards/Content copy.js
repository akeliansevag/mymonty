...
const Content = () => {
  ...
  const howToUse = [
    {
      title:
        'Download <a style="color:#2657d4" href="https://apps.apple.com/lb/app/mastercard-travel-pass/id1493489553" target="_blank">Mastercard Travel Pass App</a>',
    },
    {
  ...
  const howToUseCosta = [
    ...
    {
      title:
        "Redeem one item from the predetermined list, and show the QR code with your boarding pass to Costa staff.",
    },
  ];
  ...
  const howToUseVaidam = [
    ...
    {
      title:
        "Step 2: Select Between a complimentary second opinion or a treatment",
    },
    {
  ...
  const howToUseConcierge = [
    {
      title:
        "First call the Mastercard Travel & Lifestyle Concierge +1-332-600-6813",
    },
    {
      title:
        "Text the Mastercard Travel & Lifestyle Concierge WhatsApp line in Arabic or English.",
    },
  ];
          ...
          <div ref={travelRef} data-name="travel" className="content-category">
            {/* <div className='!pt-0 flex flex-col gap-10'>
                    ...
                    <div className='!pt-0 flex flex-col gap-5'>
                        ...
                        <div>
                            <a href="https://apps.apple.com/lb/app/mastercard-travel-pass/id1493489553" target="_blank" className="mm-button blue">Download App Now</a>
                        </div>
                        
                        <div className='h-[300px] w-full rounded-xl overflow-hidden'>
                            <img className='w-full h-full object-cover' alt="2 mobile phones" src='/world-elite-mastercard-lounge-program.webp'/>
                        </div>
                        <div>
                            <h3 className="font-bold mb-3 max-lg:mt-10">HOW TO USE:</h3>
            ...
            <div className="flex max-lg:flex-col lg:justify-between gap-10 lg:items-center">
              <div className="lg:w-3/5">
                ...
                <p>
                  ...
                  <a
                    target="_blank"
                    className="text-[var(--mm-blue)]"
                    href="http://www.ihg.com/mastercardoffer"
                  >
                    website
                  </a>
                  , you get a <strong>15% discount</strong> and exclusive offers
                  on IHG Hotels & Resorts across Europe, Maldives, India, the
                  Middle East & Africa.{" "}
                </p>
              </div>
              <div className="lg:w-2/5">
                <img
                  src="/hotel-resorts2.webp"
                  alt="Hotel Bookings"
                  width="680"
                  height="534"
                />
            ...
            <div className="flex flex-col gap-10">
              <div className="text-center">
                ...
                <p>
                  Get <strong>10% money back</strong> on your next stay through{" "}
                  <a
                    href="https://www.booking.com/gating/authkey?aid=2439504&key=mjB3VcxhAl"
                    target="_blank"
                    className="text-[--mm-blue]"
                  >
                    Booking.com
                  </a>
                </p>
              ...
              <div className="lg:aspect-[16/5] max-lg:aspect-[16/12] relative flex items-end justify-end">
                <img
                  className="absolute rounded-3xl object-cover w-full h-full top-0"
                  src="/booking-com-2.webp"
                  alt="booking"
                  width="1200"
                  height="799"
                />
                  ...
                  >
                    <g clipPath="url(#clip0_4972_8653)">
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M98 18.4329C98 8.26025 89.7508 0.00135803 79.5947 0.00135803H18.4052C8.2492 0.00135803 0 8.26025 0 18.4329V77.569C0 87.7389 8.2492 96.0006 18.4053 96.0006H79.5947C89.7508 96.0006 98 87.7389 98 77.569L98 18.4329Z"
                        fill="#0C3B7C"
                      />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M0.00390625 59.6406H48.949V96.0003H0.00394212L0.00390625 59.6406Z"
                        fill="#0C3B7C"
                      />
                      <path
                      ...
                      />
                      <path
                        d="M64.3789 65.6792C64.3789 62.4639 66.9679 59.8627 70.1577 59.8627C73.3556 59.8627 75.9567 62.4639 75.9567 65.6792C75.9567 68.8904 73.3556 71.4957 70.1577 71.4957C66.9679 71.4957 64.3789 68.8904 64.3789 65.6792Z"
                        fill="#00BAFC"
                      />
                    </g>
                    <defs>
              ...
              <div className="text-center">
                <p>
                  Use your World Elite Mastercard at checkout, and your cashback
            ...
            <div className="flex flex-col gap-5">
              <div className="text-center">
                ...
                <p>
                  Enjoy <strong>35% off</strong> your next car rental and a
                  complimentary upgrade with Avis through their{" "}
                  <a
                    target="_blank"
                    className="text-[var(--mm-blue)]"
                    href="www.avisworld.com/mastercardmea"
                  >
                    website
                  </a>
                  .
            ...
            <div className="flex max-lg:flex-col lg:justify-between gap-10">
              <div className="lg:w-3/5">
                ...
                <p className="lg:w-2/3">
                  Book with your World Elite Mastercard® to unlock Hertz Gold
                  Plus Rewards® President's Circle membership. Skip the rental
                  queue, get guaranteed car upgrades, and faster returns at over
                  7,700 locations worldwide. Just sign up at{" "}
                  <a
                    target="_blank"
                    className="text-[var(--mm-blue)]"
                    href="https://hertz.com/worldelite"
                  >
                    hertz.com/worldelite
                  </a>{" "}
                  or log in and add CDP 1795034 to your profile.
                </p>
              </div>
            ...
            <div className="flex max-lg:flex-col lg:justify-between gap-10">
              <div className="lg:w-3/5">
                ...
                <p className="lg:w-2/3">
                  Get <strong>up to 10% off</strong> on your next car or truck
                  rental. Simply visit{" "}
                  <a
                    className="text-[var(--mm-blue)]"
                    target="_blank"
                    href="www.budgetinternational.com/mastercard"
                  >
                    Budget’s website
                  </a>{" "}
            ...
            <div className="flex flex-col gap-5">
              <div className="text-center">
                ...
                <p>
                  Present your Mastercard® at the entrance & get{" "}
                  <strong>Complimentary access</strong> to{" "}
                  <strong>Global Blue City VIP Lounges</strong> for VAT refund
                  assistance & to{" "}
                  <strong>Global Blue Airport VIP Fast Lanes</strong>. Register
                  at{" "}
                  <a
                    target="_blank"
                    className="text-[var(--mm-blue)]"
                    href="https://www.globalblue.com/mastercardmea"
                  >
                    Global Blue's website
                  </a>{" "}
                  to set your eligible Mastercard® as the preferred refund
                  target.
                </p>
              </div>
              ...
              <div>
                <img
                  src="/global-blue-vip-services.webp"
                  alt="Global Blue VIP Services"
                  width="1640"
                  height="535"
                />
              </div>
            ...
            <div className="flex max-lg:flex-col lg:justify-between gap-10">
              <div className="lg:w-3/5">
                <h2 className="smaller-title">
                  Stay Connected Globally with Flexiroam
                </h2>
                <p className="lg:w-2/3">
                  Get <strong>1 GB of free</strong> global roaming data three
                  times a year with your Mastercard®, plus{" "}
                  <strong>15% off</strong> future Flexiroam plans. To redeem,
                  download the{" "}
                  <a
                    className="text-[var(--mm-blue)]"
                    target="_blank"
                    href="https://play.google.com/store/apps/details?id=com.flexiroamx&pcampaignid=web_share&pli=1"
                  >
                    Flexiroam App
                  </a>
                  , sign up, and use your card number to check eligibility.
                </p>
              </div>
              <div className="lg:w-2/5">
                <img
              ...
              <div className="lg:w-3/5">
                ...
                <p className="lg:w-2/3">
                  ...
                  <a
                    className="text-[var(--mm-blue)]"
                    target="_blank"
                    href="https://www.rentalcars.com/?affiliateCode=mastercard047&enabler=mastercardme"
                  >
                    Rentalcars.com
                  </a>
                  .
            ...
            <div>
              <div className="flex max-lg:flex-col gap-10">
                <div className="lg:w-3/5">
                  <h2 className="smaller-title">Costa Coffee</h2>
                  <p>
                    Get a free food or drink item at Costa in Dubai Airports!
                  </p>
                  <h3 className="mt-5 font-bold mb-3 max-md:mt-10">
                    HOW TO USE:
                  </h3>
                  <ul className="">
                    {howToUseCosta.map((item, index) => (
                  ...
                  <div className="pt-5">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="font-bold">Just a heads up</h3>
                      <span>
                        <svg
                          width="22"
                          height="22"
                        ...
                        >
                          <path
                            d="M11 9.5V6M11 13H11.01M8.9 18.2L10.36 20.1467C10.5771 20.4362 10.6857 20.5809 10.8188 20.6327C10.9353 20.678 11.0647 20.678 11.1812 20.6327C11.3143 20.5809 11.4229 20.4362 11.64 20.1467L13.1 18.2C13.3931 17.8091 13.5397 17.6137 13.7185 17.4645C13.9569 17.2656 14.2383 17.1248 14.5405 17.0535C14.7671 17 15.0114 17 15.5 17C16.8978 17 17.5967 17 18.1481 16.7716C18.8831 16.4672 19.4672 15.8831 19.7716 15.1481C20 14.5967 20 13.8978 20 12.5V6.8C20 5.11984 20 4.27976 19.673 3.63803C19.3854 3.07354 18.9265 2.6146 18.362 2.32698C17.7202 2 16.8802 2 15.2 2H6.8C5.11984 2 4.27976 2 3.63803 2.32698C3.07354 2.6146 2.6146 3.07354 2.32698 3.63803C2 4.27976 2 5.11984 2 6.8V12.5C2 13.8978 2 14.5967 2.22836 15.1481C2.53284 15.8831 3.11687 16.4672 3.85195 16.7716C4.40326 17 5.10218 17 6.5 17C6.98858 17 7.23287 17 7.45951 17.0535C7.76169 17.1248 8.04312 17.2656 8.2815 17.4645C8.46028 17.6137 8.60685 17.8091 8.9 18.2Z"
                            stroke="black"
                            strokeWidth="2.3"
                            strokeLinecap="round"
                    ...
                    <p>
                      After redeeming your Costa offer, lounge access will be
                      temporarily unavailable for 2 hours and vice versa.
                    </p>
                  </div>
                </div>
                <div className="lg:w-2/5 aspect-[5/4] rounded-[40px] relative overflow-hidden">
          ...
          <div ref={peaceRef} data-name="peace" className="content-category">
            <div className="flex max-lg:flex-col gap-10 lg:justify-between">
              <div className="lg:w-2/5">
                ...
                <p>
                  Travel with peace of mind! your Mastercard® covers you
                  automatically.
                  <br />
                  Get up to USD 500,000 in medical, accident, and emergency
                  ...
                  <a
                    target="_blank"
                    className="text-[var(--mm-blue)]"
                    href="https://mcpeaceofmind.com"
                  >
                    mcpeaceofmind.com
                  </a>{" "}
                  to learn more and travel confidently!
                </p>
              </div>
              <div className="lg:w-2/5">
                <img
                  src="/medical-insurance.webp"
            ...
            <div className="flex max-lg:flex-col gap-10 lg:justify-between">
              <div className="lg:w-2/5">
                ...
                <p>
                  Travel disruptions? World Elite Mastercard® has you covered.
                  Get up to USD 7,500 for trip cancellations, baggage delays,
                  and more.
                  <br />
                  Visit{" "}
                  <a
              ...
              <div className="lg:w-2/5">
                <img
                  src="/travel-insurance-inconvenience.webp"
                  alt="Travel Inconvenience Insurance"
                  width=""
                  height=""
                />
              </div>
              ...
              <div className="lg:w-2/5">
                ...
                <p>
                  ...
                  <a
                    target="_blank"
                    className="text-[var(--mm-blue)]"
                    href="https://mcpeaceofmind.com/worldelite"
                  >
                    mcpeaceofmind.com/worldelite
                  </a>{" "}
                  or call Concierge to file a claim.
                </p>
              </div>
              <div className="lg:w-2/5">
                <img
                  src="/rental-collision-and-loss-damage-waiver.webp"
                  alt="Rental Collision and Loss Damage Waiver"
                  width="680"
                  height="501"
                />
              </div>
            ...
            <div className="flex max-lg:flex-col gap-10 lg:justify-between">
              <div className="lg:w-2/5">
                ...
                <p>
                  Get your official Travel Insurance Confirmation Letter with
                  World Elite Mastercard®.
                  <br />
                  Ensure visa requirements are met with coverage for parents and
                  children.
                  <br />
                  Visit{" "}
                  <a
                  ...
                  to generate your letter effortlessly!
                </p>
              </div>
              <div className="lg:w-2/5">
                <img
                  src="/travel-insurance-confirmation-letter.webp"
                  alt="Travel Insurance Confirmation Letter"
                  width="680"
                  height="501"
                />
              </div>
          ...
          >
            <div className="flex max-lg:flex-col gap-10 lg:justify-between">
              <div className="lg:w-2/5">
                ...
                <p>
                  Access 24/7 VIP service with your World Elite Mastercard®.
                  From booking travel to finding last-minute reservations, help
                  is always a call or a message away.
                  <br />
                  <br />
                  Chat anytime on WhatsApp or call your dedicated concierge
                  number.
                  <br />
                  <br />
                  For Arabic: +44 7418 368707
                  <br />
                  For English: +44 7418 368708
                  <br />
                  <br />
                </p>
                <ul className="">
              ...
              <div className="lg:w-2/5 rounded-[40px] relative overflow-hidden">
                <img
                  src="/mastercard-concierge.webp"
                  alt="Mastercard Concierge"
                  width="680"
                  height="689"
                />
              </div>
            ...
            <div className="flex max-lg:flex-col gap-10 lg:justify-between">
              <div className="lg:w-2/5">
                ...
                <p>
                  Up to <strong>15% off</strong> shopping packages, transfers,
                  and more at Europe’s top designer outlets.
                  <br />
                  Get an extra 10% off with your VIP Card when you pay with your
                  eligible Mastercard®. Unlock your benefits{" "}
                  <a
              ...
              <div className="lg:w-2/5 rounded-[40px] relative overflow-hidden">
                <img
                  src="/european-shopping-collection.webp"
                  alt="Bicester Village Shopping Collection"
                  width="680"
                  height="575"
                />
              </div>
            ...
            <div className="flex max-lg:flex-col gap-10 items-center lg:justify-between">
              <div className="lg:w-3/5">
                ...
                <p>
                  ...
                  worldwide with MyUS.
                  <br />
                  Get 2 years of free Premium Membership,{" "}
                  <strong>up to 30% off</strong> shipping, and more.
                  <br />
                  Simply use your Mastercard at checkout:{" "}
                  <a
                    className="text-[var(--mm-blue)] break-all"
                    target="_blank"
                    href="https://www.myus.com/welcome/mastercardpremium/"
                  >
            ...
            <div className="flex max-lg:flex-col gap-10 lg:justify-between">
              <div className="lg:w-3/5">
                <h2 className="smaller-title">
                  Mastercard® Gamer Pass with Go Gamers
                </h2>
                <p>
                  Mastercard® Gamer Pass with Go Gamers get{" "}
                  <strong>50% off</strong> Premium Membership.
                  <br />
                  Join global tournaments, win prizes, and access expert
                  coaching to sharpen your skills.
                  <br />
                  Start now at{" "}
                  <a
                    target="_blank"
                    className="text-[var(--mm-blue)]"
                    href="https://gogamers.tech/"
                  >
                    www.gogamers.tech
                  </a>{" "}
            ...
            <div className="flex max-lg:flex-col gap-10 lg:justify-between">
              <div className="lg:w-3/5">
                ...
                <p>
                  ...
                  <br />
                  Enjoy up to 10% off service fees, free second opinions, and
                  concierge support in select countries.
                  <br />
                  <br />
                </p>
                <ul className="">
            ...
            <div className="flex max-lg:flex-col gap-10 lg:justify-between">
              <div className="lg:w-2/5">
                <div>
                  ...
                  <p>
                    1 week of complimentary Lingokids Plus access, 50% off all
                    future monthly subscriptions for life & full access to
                    premium content, even offline.
                    <br />
                    <br />
                    Visit the{" "}
                    <a
                      target="_blank"
                      className="text-[var(--mm-blue)]"
                      href="https://lingokids.com/mastercardmea"
                    >
                      Lingokids Mastercard page
                    </a>
                    , enter promo code MASTERCARD50, and click Redeem.
                  </p>
                </div>
              </div>
            ...
            <div className="flex max-lg:flex-col gap-10 lg:justify-between">
              <div className="lg:w-2/5">
                ...
                <p>
                  Crush your fitness goals with Fiit. <br />
                  Get a 14-day free trial and <strong>25% off</strong> your
                  first payment. Visit{" "}
                  <a
                    target="_blank"
                    className="text-[var(--mm-blue)]"
                    href="https://getfiit.tv/mastercard"
                  >
            ...
            <div id="shahid" className="!pb-0 !border-b-0 ">
              <div>
                <h2 className="smaller-title">
                  Get All the Drama for Half the Price
                </h2>
                <p>
                  <strong>
                    Get 50% Off Shahid VIP with Your MyMonty Card.
                  </strong>{" "}
                  Your favorite shows just got more affordable.{" "}
                  <strong>Enjoy 50% off your Shahid VIP monthly plan</strong>{" "}
                  when you use an eligible <strong>MyMonty Mastercard®.</strong>
                </p>
                <p className="text-lg mt-5">
                  Offer is valid for newly registered MyMonty Mastercard cards
                  on the Shahid platform only.
                </p>
              </div>
              <div className="flex max-lg:flex-col items-center gap-10 mt-10">
                <div className="lg:w-3/5">
                  <h3 className="mt-5 font-bold mb-3 max-md:mt-1 uppercase">
                  ...
                  <h3 className="mt-5 font-bold mb-3 max-md:mt-10 uppercase">
                    terms & conditions
                  </h3>
                  <a
                    href="/Shahid-T&Cs - May 2025.pdf"
                    target="_blank"
                    className="mm-button blue mt-1"
                  >
