            ...
            <Section>
                <div className='max-w-[1060px] mx-auto w-full'>
                    <div className='container text-center'>
                        <TextBlock buttonColor="dark" center={true} title="Enter a world of privilege with the World Elite Credit Card." description="Live every moment in first-class. Break away from the ordinary. Shop, dine and travel in style." button={true} />
