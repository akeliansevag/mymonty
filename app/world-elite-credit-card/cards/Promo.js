    ...
    <div className={`${black ? `bg-black text-white` : `bg-white text-black`} relative ${full ? `w-full` : `max-lg:w-full lg:w-[280px]`} h-[108px] my-4 p-5 flex text-center items-center justify-center`}>
      <div className="absolute left-[1px] -translate-x-full">
        ...
        <div className="absolute right-[1px] translate-x-full">
          <svg width="15" height="108" viewBox="0 0 15 108" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_3486_5595)">
            <path d="M14.9999 13.5084C14.9999 6.04793 8.95202 0 1.49153 0H-232.654C-240.115 0 -246.163 6.04792 -246.163 13.5084V39.0244H-246.161C-237.84 39.0244 -231.094 45.7701 -231.094 54.0915C-231.094 62.4128 -237.84 69.1585 -246.161 69.1585H-246.163V94.9746C-246.163 102.435 -240.115 108.483 -232.654 108.483H1.49151C8.95201 108.483 14.9999 102.435 14.9999 94.9746V69.1585V69.1585C6.67863 69.1585 -0.0676994 62.4128 -0.0676994 54.0915C-0.0676994 45.7701 6.67806 39.0244 14.9994 39.0244V39.0244L14.9999 13.5084Z" fill={ black ? "black" : "white" }/>
            </g>
            <defs>
