                ...
                <div className='max-w-[1060px] mx-auto w-full'>
                    <div className='container text-center'>
                        <div className="md:max-w-full lg:max-w-[60vw] fhd:max-w-[45vw] mx-auto">
                            <h2 className='uppercase font-black text-3xl sm:text-5xl md:text-[2.875rem] leading-none text-balance'>Live bold, spend <span className='text-[#CDA65A]'>Gold.</span></h2>
