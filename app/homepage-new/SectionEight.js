            ...
            <div className='container'>
                <div className='flex flex-col md:flex-row max-lg:gap-10 lg:gap-32 items-center'>
                    <div className='w-full lg:w-1/2'>
                        ...
                        <p className='leading-8 mt-8'>Get instant access to our dedicated support team directly from the web. Whether you have a question or need assistance. We’re always here to help.</p>
                    </div>
