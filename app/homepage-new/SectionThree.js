      ...
      <div className="container">
        ...
        <div className="flex gap-5 max-lg:flex-col mt-16">
          ...
          <div className="lg:w-[65%] flex flex-col gap-5">
            <div className="bg-[#f7f7f7] flex flex-col h-full rounded-3xl overflow-hidden relative max-lg:gap-3">
              ...
              <div className="max-lg:pt-0 lg:pt-8 w-11/12 lg:w-4/5 ml-auto mt-auto">
