...
export const metadata = {
  title: 'Business World Elite Credit Card' + websiteName,
  description: '',
};

export default function Page() {
    const data = {
        title: 'Business World Elite Credit Card',
        subtitle: 'Cards',
        desc: 'MyMonty Business World Elite Credit Card',
        image: {
            inGrid: true,
            layout: 'half',
    ...
    return (
        <div className='bg-black text-white'>
            ...
            <SectionScrollLayout title="Business World Credit Card" sections={sections}>
