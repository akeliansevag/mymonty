...
export default function Page() {
    const data = {
        title: 'Business World Credit Card',
        subtitle: 'Cards',
        desc: 'MyMonty Business World Credit Card',
        image: {
            inGrid: true,
            layout: 'half',
    ...
    const travelCards = [
        {
            ...
            description: "Unlimited complimentary airport lounge access in over 135 countries with your World Mastercard. Download the Mastercard Travel Pass App and present the app QR code to the lounge receptionist.",
        ...
        {
            title: "Free Airport Rides with Careem (for Commercial)",
            description: 'Use your Mastercard to enjoy 2 complimentary airport transfers twice every year with Careem. Enter the relevant promo code to redeem the offer.',
            image: "free-airport-rides",
        },
        {
    ...
    const carRentalsCards = [
        ...
        {
            title: "Hertz",
            description: 'Free Gold Plus Membership with Hertz. Visit <a href="https://www.budgetinternational.com/mastercard" target="_blank" rel="noopener noreferrer">hertz.com/mcworld</a> to unlock your benefits.',
            image: "hertz-business",
        },
        {
            title: "Avis Car Rental & Chauffeur Services",
            description: 'Enjoy up to <strong>35% off</strong> your next car rental with Avis & complimentary Avis President’s Club membership. Visit <a href="https://www.budgetinternational.com/mastercard" target="_blank" rel="noopener noreferrer">avisworld.com/mastercardmea</a> and book with your Mastercard.',
            image: "avis-car-rental",
        },
    ]
        ...
        <div className='bg-black text-white'>
            ...
            <div className='container text-center py-10 lg:py-20'>
                <div className="md:max-w-full lg:max-w-[60vw] fhd:max-w-[45vw] mx-auto">
                    <h2 className='uppercase font-black text-3xl sm:text-5xl md:text-[2.875rem] leading-none text-balance'>Business Luxury</h2>
                    <p className="leading-8 mt-8">Access a world of premium business privileges. From unlimited airport lounge access to exclusive global benefits, it supports executives who operate across borders.</p>
                </div>
                <Image className='mx-auto mt-14' alt="Wallets" src={sectionTwoImage} width='2120' height='860' />
            </div>

            <SectionScrollLayout title="Business World Credit Card Benefits" sections={sections}>
