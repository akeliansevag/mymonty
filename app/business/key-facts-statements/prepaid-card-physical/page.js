...
export const metadata = {
    title: 'Business Platinum Prepaid Mastercard | Key Facts & Terms' + websiteName,
    description: 'Important details for your Business Platinum Prepaid Mastercard in Lebanon. Access key facts & essential statements for secure usage. View now.'
};
...
const pea = () => {
    ...
    return (
        <div>
            ...
            <FooterBanner downloadURL="/KFS-Business-Platinum-Prepaid-Card.pdf" title="Business Platinum Prepaid Mastercard: Key Facts & Statements" />
            <div className='container py-10 lg:py-20 relative'>
                <p>
                    <strong>BUSINESS PLATINUM PREPAID MASTERCARD - KEY FACTS STATEMENT  <br />
                        (V.1.0 – 28 October 2025)</strong> </p>

                <p className='mt-5 mb-10'>This Key Facts Statement (“<strong>KFS</strong>”) provides you with information on the key features, limits, fees and charges of the MyMonty Business Platinum Prepaid Mastercard offered by Monty Finance SAL (“<strong>Card</strong>”). This KFS does not contain all the terms and conditions governing the Card and it should be read along with the <a className='text-blue-500 hover:underline' href="/Platinum-Prepaid-Cards-Terms-(V.1.0---NPY).pdf" target="_blank">Business Prepaid Mastercard Terms.</a>.</p>
