...
// ================= BANNER DATA =================
const data = {
  title: 'REWARDS & SPENDING',
  subtitle: 'Benefits & Offers',
  desc: 'Filter through our partner network and track your spending across key business categories.',
  cta: null,
};
...
const rewards = [
  ...
  },
  {
    id: 3,
    title: 'OSN+',
    description: 'Get 4 months OSN+ subscription on us.',
    category: 'Entertainment & Media',
    badge: '4 Months On Us • 15% OFF',
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
          {filteredRewards.map(item => (
            <Link
              key={item.id}
              href={item.link}
              className="group rounded-2xl bg-white p-4 shadow-sm hover:shadow-md transition flex flex-col gap-3"
            >
