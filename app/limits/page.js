...
const terms = () => {
    ...
    return (
        <div className={styles.terms}>
            ...
            <FooterBanner downloadURL="/List of Limits 29.7.25.pdf" title="Personal Account and Cards Limits" />
            <div className='container py-10 lg:py-20 relative'>
                <div className='text-base html-content'>
                    <p className='mb-10'>(effective as of 29 July 2025)</p><br />

                    <h2>Personal eWallet Account</h2>

                    <h3 className="font-bold underline">Account maximum balance</h3>
                    <p><strong>Maximum Balance at any one time:</strong><br />Your account balance may not exceed USD 30,000 or its equivalent in other currencies at any time.</p><br />
                    <p><strong>Maximum Credit Balance per month:</strong><br />The total monthly credit balance on your account (whether from top-ups or incoming transfers) cannot exceed USD 50,000 or its equivalent in other currencies.</p><br />
                    ...
                    <p><strong>Through MyMonty SST:</strong><br />Any amount (as long as the account balance does not exceed the maximum account balance and monthly credit limits) <br />Transaction Limit: In USD – 3,000 / In LBP – 30,000,000 <br />Daily Limit: USD 9,000 (or its equivalent in other currencies)</p><br />
                    <p><strong>Through our Appointed Agent:</strong><br />Any amount (as long as the account balance does not exceed the maximum account balance and monthly credit limits) <br />*Limit of LBP 15,000,000 per top-up transaction.</p><br />
                    ...
                    <p><strong>Through MyMonty SST:</strong><br />In USD – 3,000 per transaction, up to the available USD balance / In LBP – 30,000,000 per withdrawal transaction, up to the full available LBP balance</p><br />
                    <p><strong>Through our integrated ATMs:</strong><br />Per Transaction: USD 2,000 / LBP 3,000,000 <br />Daily: USD 9,000 (or its equivalent in other currencies) <br />Monthly: USD 50,000 (or its equivalent in other currencies)</p><br />
                    ...
                    <p><strong>Conversion monthly limit:</strong><br />USD 50,000 or its equivalent in LBP (in accordance with the wallet limit)</p><br />
                   ...
                   <h3 className="font-bold underline">Maximum Card Balance</h3>
