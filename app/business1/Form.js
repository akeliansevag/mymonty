...
const Form = () => {
  ...
  const validateForm = () => {
    ...
    const requiredFields = ['first_name', 'last_name', 'email', 'position', 'code', 'mobile'];
          ...
          <div className='flex flex-col md:flex-row max-lg:gap-6 gap-10'>
            ...
            <div className='flex flex-col gap-1 w-full'>
              ...
              <input
                ...
                className={`px-3.5 py-2.5 border-2 w-full border-gray-300 rounded-xl ${errors.position ? 'border-red-500' : ''
                  }`}
              />
